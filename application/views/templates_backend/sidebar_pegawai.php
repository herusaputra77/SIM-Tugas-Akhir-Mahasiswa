          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <!-- Add icons to the links using the .nav-icon class
                ...
                <p>Dashboard</p>
                 ...
                 <li class="nav-item">
                 <a href="<?= base_url('pegawai/mahasiswa/')?>" class="nav-link  ">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= base_url('pegawai/pembimbing/pembimbing_pa')?>" class="nav-link">
                    <i class="fas fa-user nav-icon"></i>
                    <p>Pembimbing Akademik</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= base_url('pegawai/pembimbing/')?>" class="nav-link">
                    <i class="fas fa-user nav-icon"></i>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= base_url('pegawai/tugas_akhir/proposal')?>" class="nav-link">
                    <i class="fas fa-file nav-icon"></i>
                    <p>Proposal</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= base_url('pegawai/tugas_akhir/bimbingan/')?>" class="nav-link">
                    <i class="fas fa-file nav-icon"></i>
                    <p>Bimbingan</p>
                  </a>
                </li>
