          ...
          <table class="table table-hover table-striped table-bordered" id="mytabel">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="<?= base_url('admin/pembimbing/mahasiswa_pa/'). $value['id_dosen']?>" class="btn btn-sm btn-warning"><i class="fas fa-eye"></i> Lihat Mahasiswa</a></td>
              </tr>
            <?php }?>
            </tbody>
            
          </table>
          <a href="<?= base_url('admin/pembimbing/tambah_pembimbing_pa/')?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Pembimbing</a>
