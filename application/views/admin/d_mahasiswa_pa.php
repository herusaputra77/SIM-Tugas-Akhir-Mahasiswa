    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
           <input type="hidden" name="redirect_page" value="<?= base_url('admin/pembimbing/mahasiswa/').$this->uri->segment(4)?>">
          <div class="row">
        ...
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('admin/pembimbing/hapus_mhs_pa/')?>" method="post">
                <input type="hidden" name="redirect_page" value="<?= base_url('admin/pembimbing/mahasiswa_pa/').$this->uri->segment(4)?>">
