        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-sm<?php echo $value['id_mhs']?> ">
                <i class="fas fa-edit"></i> Edit</button> <a href="<?= base_url('pegawai/mahasiswa')?>" class="btn btn-sm btn-success"> <i class="fas fa-arrow-circle-left"></i> Kembali</a>
                <?php } ?>
          <!-- /.row -->
          <!-- Main row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= base_url('pegawai/mahasiswa/edit_aksi')?>" method="post" >
