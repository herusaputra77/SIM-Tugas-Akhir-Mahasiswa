    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <a href="<?= base_url('pegawai/dosen/tambah/')?>" class="btn btn-sm btn-primary mb-2"><i class="fas fa-plus"> Tambah</i></a>
           <div class="">
            ...
            <tbody>
              ...
              <tr>
                ...
                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-sm<?php echo $ds->id_dosen?> ">
                  ...
                  <a href="<?= base_url('pegawai/dosen/detail_dosen/').$ds->id_dosen?>" class="btn btn-sm btn-secondary"><i class="fas fa-eye"></i></a>
                </td>
              </tr>
            <?php }?>
            </tbody>
        ...
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('pegawai/dosen/hapus/')?>" method="post">
