          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
               <li class="breadcrumb-item"><a href="<?= base_url('pegawai/dashboard/')?>">Tugas Akhir</a></li>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php if($ps['status'] == 'Disetujui Pembimbing'){?>
                            <a href="<?= base_url('pegawai/tugas_akhir/detail_proposal/'.$ps['id_skripsi'])?>" class="btn btn-sm btn-primary">Detail</a>
        ...
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('pegawai/tugas_akhir/setuju/')?>" method="post">
    ...
    <div class="modal fade" id="modal-sm<?= $value['id_skripsi']?>">
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('pegawai/tugas_akhir/tolak/')?>" method="post">
