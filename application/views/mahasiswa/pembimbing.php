          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Pembimbing I</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                <div class="card-body">
                  <div class="row">
                      <?php if(!empty($Pembimbing['id_mahasiswa'])){?>
                        ...
                        <?php }else{ ?>
                    <div class="col-md-3">
                     <img src="<?= base_url('assets/image/dosen/').$pembimbing['image']?>" style="width: 100px;">
                    </div>
                    <div class="col-md-9">
                      <div class="">
                      <label>Nama</label>
                      <label>:</label>
                      <label><?= $pembimbing['nama']?></label>  
                      </div>
                      <div class="">
                      <label>NIP</label>
                      <label>:</label>
                      <label><?= $pembimbing['nip']?></label>  
                      </div>
                      <?php } ?>
                    </div>
