...
class Mahasiswa extends CI_Controller {
	...
	public function index()
	{
		...
		$data['mahasiswa'] = $this->db->get_where('tb_mahasiswa', ['prodi' =>$prodi])->result();
		...
		$this->load->view('pegawai/mahasiswa', $data);
	...
	public function tambah()
	{
		...
		$this->load->view('templates_backend/topbar_pegawai',$data);
		$this->load->view('templates_backend/sidebar_pegawai');
		$this->load->view('pegawai/tambah_mahasiswa', $data);
		$this->load->view('templates_backend/footer');	
		}else{
	...
	public function detail($id)
	{
		...
		$this->load->view('templates_backend/topbar_pegawai',$data);
		$this->load->view('templates_backend/sidebar_pegawai');
		$this->load->view('pegawai/detail_mahasiswa', $data);
		$this->load->view('templates_backend/footer');
	}
